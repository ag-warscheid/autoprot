...
Head over to the [R repo](https://cran.r-project.org/bin/) and download a version of R suitable for your operating system.
...
Alternatively, you may [install R using anaconda](https://docs.anaconda.com/anaconda/user-guide/tasks/using-r-language/),
...
It is recommended to manage environment with the anaconda package manager (see [Anaconda](https://www.anaconda.com/)).
...
to also install [mamba](https://mamba.readthedocs.io/en/latest/)::
