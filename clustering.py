...
class Cluster:
    ...
    def __init__(self, data, clabels=None, rlabels=None, zscore=None,
        ...
        def sanitizeData(data, clabels, rlabels, zs):
            """
            ...
            rlabels : row labels of the reduced dataset
            clabels : column labels of the reduced dataset
            ...
            try:
                ...
                raise Exception(f'Error during data sanitation: {e}')
    ...
    def visCluster(self, colCluster=False, makeTraces=False,
        ...
        **kwargs :
        ...
        if rowColors is not None:
            ...
            rowColors_df = pd.DataFrame(rowColors)
        ...
        sns.clustermap(pd.DataFrame(self.data,
                       ...
                       col_cluster=colCluster, # cluster the columns (y/n)
